...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow" style="background-color: #603c3c !important;">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="pagina-inicial.php">Biblioteca Zyaon</a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="pagina-inicial.php">
